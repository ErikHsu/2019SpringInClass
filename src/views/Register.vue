                ...
                <form @submit.prevent="submit"> 
                    <div class="form-group">
                        ...
                        <input type="text" v-model="data.FirstName"
                            class="form-control" name="First Name" id="FirstName" aria-describedby="helpFirstName" placeholder="First Name">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" v-model="data.LastName"
                            class="form-control" name="Last Name" id="LastName" aria-describedby="helpLastName" placeholder="Last Name">
                        <small id="helpLastName" class="form-text text-muted">Please enter your last name here.</small>
                    </div>  
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <small id="helpBirthday" class="form-text text-muted">Please enter your birthday here.</small>
                    </div>
